<script lang="ts">
    ...
    type DemoModule = (typeof demo_modules)[number];
    let selected_module = $state<DemoModule>(demo_modules[0]);
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="border border-gray-200 rounded-lg p-4">
                            ...
                            <ProgressTracker
                                ...
                                userId={demo_user_id}
                                onProgressUpdate={handle_progress_update}
                            />
                        </div>
                    </div>
                </div>
